...
CREATE TABLE commande_ligne(
  commandeligneid integer NOT NULL PRIMARY KEY,
  nom character varying(255) NOT NULL,
  quantite integer NOT NULL,
  prix_unitaire real NOT NULL,
  prix_total real NOT NULL,
  commande_id integer REFERENCES commande (commandeid)
);



INSERT INTO commande_ligne (commandeligneid, commande_id, nom, quantite, prix_unitaire, prix_total) VALUES
